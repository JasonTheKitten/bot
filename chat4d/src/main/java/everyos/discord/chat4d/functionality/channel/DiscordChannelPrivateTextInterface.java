...
public class DiscordChannelPrivateTextInterface implements ChatChannelTextInterface {
	private PrivateChannel channel;
	private ChatConnection connection;

	public DiscordChannelPrivateTextInterface(ChatConnection connection, PrivateChannel channel) {
